...
<script>
  $(document).ready(function() {
    ...
    $('#pcgStaffFormAdd').on('submit', function(event) {
      ...
      $.ajax({
          url: 'php/ched/add_pcg_staff.php', // Update with the correct URL of your PHP script
          type: 'POST',
          data: formData,
          ...
          success: function(response) {
            ...
            Swal.fire({
              ...
              $('#main').load('list_views/ched/list_pcg_staff.php'); // Reload the page to update the table
              // $('#loader').hide();
            });
          },
